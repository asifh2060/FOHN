...
export default class Feature_Near_You extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            userRole: props.navigation.getParam("value"),
    ...
    getBuilderApi = () => {
        ...
        console.log("getBuilderApi Params: ", JSON.stringify(details))
        var requestPramas = []
        ...
        fetch(API.GET_USER_BY_ROLE, {
            ...
            console.log('getBuilderApi Response: ' + JSON.stringify(response));
        ...
        return (
            <TouchableOpacity onPress={()=>{this.props.navigation.navigate("StacyMartinRealator",{
                ...
                <ImageBackground source={{uri: item.profile_photo ? item.profile_photo : item.publisher_profile_photo  }} style={style.listImageCont}>
                    <TouchableOpacity 
                    onPress={()=>{this.props.navigation.navigate("StacyMartinRealator",{
                        userId:item.id
                    })}}
                    style={style.listImgBtn}>
        ...
        return (
            ...
            <SafeAreaView style={[style.mainContainer,{backgroundColor:appThemeMode==='light' ? Colors.white :Colors.black}]}>
                <Header
                    ...
                    centerComponent={ this.state.userRole == 'um_builder' ?  "Featured Builders Near You" : 'Sale By Owners Near You'}
