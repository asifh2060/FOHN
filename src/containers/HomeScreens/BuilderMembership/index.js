...
const itemSkus = Platform.select({
    ios: [
        'com.subscription.professional.monthly',
        'com.subscription.monthly.executive',
        'com.subscription.professional.yearly',
        'com.subscription.yearly.executive'
    ],
    android: ['com.example.productId'],
});
const itemSubs = Platform.select({ ios: ['test.sub'], android: ['test.sub'] });

export default class BuilderMembership extends Component {
    ...
    async componentDidMount(): void {
        ...
        //             console.warn('purchaseErrorListener', JSON.stringify(error));
        //         });
        //     })
        // })
        ...
        purchaseUpdateSubscription = purchaseUpdatedListener(
            async (purchase: InAppPurchase | SubscriptionPurchase | ProductPurchase) => {
                console.log('purchaseUpdatedListener', purchase);
                if (
            ...
            <View style={[style.shadowOffset]}>
                ...
                <TouchableOpacity onPress={() => {
                    this.setState({
                        ...
                        this.requestSubscription(item.subScriptionId)
                        // this.props.navigation.navigate("purchaseMemberShip", {
                        //     itemPrice: this.state.subPrice
                        // })
                    })
        ...
        return (
            <SafeAreaView style={[style.mainContainer ,{backgroundColor:appThemeMode==='light' ?  Colors.white :Colors.black }]}>
                <Header
                    ...
                    centerComponent={"BUILDERS MEMBERSHIPS"}
