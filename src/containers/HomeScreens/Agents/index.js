...
export default class Feature_Near_You extends Component {
    ...
    getAgentApi = () => {
        const details = {
            ...
            user_role: "um_insurance-agent",
            login_user_id: this.state.userData ? this.state.userData.id : ''
        };
        this.setState({
            loading: true
        })
        console.log("getAgentApi Params: ", JSON.stringify(details))
        var requestPramas = []
        ...
        fetch(API.GET_USER_BY_ROLE, {
            ...
            console.log('getAgentApi Response: ' + JSON.stringify(response));
    ...
    renderItem(item) {
        return (
            <TouchableOpacity onPress={()=>{this.props.navigation.navigate("StacyMartinRealator",{
                userId:item.id
    ...
    render() {
        ...
        return (
            <SafeAreaView style={[style.mainContainer, { marginTop: 20,backgroundColor:appThemeMode==='light' ? Colors.white :Colors.black }]}>
                <Header
                    leftAction={this.leftAction.bind(this)}
                    rightAction={this.rightAction.bind(this)}
                    HeaderColor={'#707070'}
                    leftIcon={require('../../../assets/images/back.png')}
                    centerComponent={"Insurance Agents Near You"}
                ...
                <ScrollView
                    ...
                    style={[style.mainContainer, { marginTop: 20, marginTop: 20,backgroundColor:appThemeMode==='light' ? Colors.white :Colors.black  }]}>
